with open('/teamspace/studios/this_studio/sir_ml_project/dashboard_v2.py', 'r') as f:
    code = f.read()

with open('/teamspace/studios/this_studio/sir_ml_project/dashboard_v2_backup.py', 'w') as f:
    f.write(code)

NEW_FUNC = '''def predict_epidemic(beta, gamma, model_choice, show_uncertainty):
    ...
    if model_choice == "MLP":
        ...
        mean, std_t = mc_model.predict_with_uncertainty(inp_t, n=100)
        pred   = mean.numpy() * N
...
with open('/teamspace/studios/this_studio/sir_ml_project/dashboard_v2.py', 'w') as f:
    f.write(new_code)
